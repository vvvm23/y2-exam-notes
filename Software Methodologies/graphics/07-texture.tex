...
A final alternative is to use a displacement mapping. This actually moves the surface points. The new geometry must be displaced before visibility is determined so must be done as a preprocessing step.
\\
